...
public class C01_Variables {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        System.out.println("yagisVarMi = " + yagisVarMi); //sout yerine soutv ile daha kolay
        ...
        double a = 0.2, b=0.3; //data tipi aynıysa aynı satırda böyle yazılabilir.
        long populationWorld = 70000000L;
        long x = 1234;
